...
def on_intent(intent_request, session):
    ...
    if intent_name == "askCleverIntent":
        return askClever(intent, session)
...
def get_welcome_response():
    session_attributes = {}
    card_title = "CleverBot"
    speech_output = "I can talk to Clever bot, and see what he says, just say something like Hi, how are you? To get started."
